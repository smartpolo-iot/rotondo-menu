...
const MOCK_REVIEWS: Review[] = [
  { id: '1', author: 'Lucía M.', rating: 5, comment: 'Los buñuelos de zucchini son de otro planeta.', date: '2024-03-10' },
        ...
        <div className="flex-grow overflow-y-auto">
          ...
          <div className="p-6 bg-white border-b border-gray-100">
            {!showForm ? (
              ...
              >
                + {lang === 'es' ? 'DEJANOS TU RESEÑA' : 'LEAVE A REVIEW'}
              </button>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4 animate-in fade-in slide-in-from-top-4 duration-300">
                <div className="flex justify-between items-center mb-2">
                  <h3 className="font-voltaire font-bold text-lg uppercase text-gray-700">Nueva Reseña</h3>
