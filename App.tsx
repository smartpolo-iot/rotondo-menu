        ...
        <header className="px-4 py-4 flex items-center justify-between border-b border-gray-100">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <h1 className="text-2xl font-jost font-normal uppercase text-[#394869] tracking-tight">Rotondo Café</h1>
            </div>
          </div>
        </header>
        ...
        <div ref={carouselRef} className="flex items-center gap-2 p-3 overflow-x-auto hide-scrollbar scroll-smooth whitespace-nowrap bg-white shadow-inner">
          {promotionItems.length > 0 && (
            <button
              ...
              className={`px-6 py-3 text-[11px] font-bold font-montserrat uppercase tracking-[0.15em] cursor-pointer transition-all ${activeCategory === 'PROMOCIONES' ? 'bg-[#394869] text-white shadow-md scale-105' : 'bg-gray-50 text-gray-400 hover:bg-gray-100'
                }`}
            >
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-6 py-3 text-[11px] font-bold font-montserrat uppercase tracking-[0.15em] cursor-pointer transition-all ${activeCategory === cat ? 'bg-[#394869] text-white shadow-md scale-105' : 'bg-gray-50 text-gray-400 hover:bg-gray-100'
                }`}
            >
              {cat}
            </button>
